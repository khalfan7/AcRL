...
if __name__ == '__main__':
    ...
    model = PPO(policy='MlpPolicy', env=env, n_steps=2048, batch_size=64, n_epochs=10, learning_rate=0.0003, gamma=0.98, gae_lambda=0.95, ent_coef=0.01, device='auto', seed=42, verbose=1, tensorboard_log=log_dir)
